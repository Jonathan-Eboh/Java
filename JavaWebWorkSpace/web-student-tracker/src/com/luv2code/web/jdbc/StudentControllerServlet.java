...
import javax.servlet.RequestDispatcher; //imported this as the second option from a list of two
...
public class StudentControllerServlet extends HttpServlet {
	...
	private void listStudents(HttpServletRequest request, HttpServletResponse response) 
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/list-students.jsp"); //watch this line!
		dispatcher.forward(request, response);
	}
